...
contains
  ...
  subroutine pf_read_opts(pf, read_cmd, fname)
    ...
    logical          :: pipeline_g , pfasst_pred
    ...
    namelist /pf_params/ pipeline_g, pfasst_pred, taui0
  ...
  subroutine pf_print_options(pf, unitno, show_mats)
    ...
    write(un,*) 'nvars:       ', pf%levels(1:pf%nlevels)%ndofs, '! number of degrees of freedom per level'
